...
class oldAdministration extends React.Component {
    ...
    handleChange = event => {
        ...
        const areadId = "5ce9b53d5a5d3d0484282cfb";
        api.infoRecognition.getPointsTotalAllPeriodSelected(areadId, event.target.value)
            .then(data => {
                this.setState({
...
oldAdministration.propTypes = {
    classes: PropTypes.object.isRequired,
};
function mapStateToProps(state) {
    return { user: state.auth };
}
export default connect(mapStateToProps, null)(withStyles(styles)(oldAdministration));