...
class oldProduction extends React.Component {
    ...
    handleChange = event => {
        ...
        const areadId = "5ce9b52a5a5d3d0484282cfa";
...
oldProduction.propTypes = {
    classes: PropTypes.object.isRequired,
};
function mapStateToProps(state) {
    return { user: state.auth };
}
export default connect(mapStateToProps, null)(withStyles(styles)(oldProduction));