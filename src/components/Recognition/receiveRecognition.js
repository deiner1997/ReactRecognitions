...
class listReceiveRecognition extends React.Component {
    ...
    componentDidMount() {
        api.infoRecognition.getReceiveRecognitions()
            .then(data => {
...
listReceiveRecognition.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(listReceiveRecognition);